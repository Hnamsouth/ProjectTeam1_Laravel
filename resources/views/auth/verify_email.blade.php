<div style="font-family:Helvetica,sans-serif">
    <div style="width:600px;height:100%;margin:auto">
        ...
        <div>
            ...
            <div>
                <p style="font-size:16px;margin-bottom:16px;line-height:24px">
                    Please confirm that you want to use this email address with your SouthBank account. If you did not request this change, then feel free to ignore this email.
                </p>
                <p style="font-size:16px;margin-bottom:16px;line-height:24px">
        ...
        <p>
            ...
            <span style="line-height:24px;font-size:16px">The SouthBank</span>
        </p>
        ...
        <footer style="margin-bottom:40px">
            <span style="color:#919eab;line-height:28px;font-size:12px">SouthBank, 8 Ton That Thuyet Street, Hanoi, Vietnam</span><br>
            <span style="color:#919eab;line-height:28px;font-size:12px">You received this because you're a registered SouthBank user. Do not reply</span><br>

            <span style="color:#919eab;line-height:28px;font-size:12px">
            Questions? Check out the <a href="#" style="color:#919eab;line-height:28px;font-size:12px;text-decoration:underline" target="_blank" data-saferedirecturl="https://www.google.com/url?q=https://developer.nexmo.com/&amp;source=gmail&amp;ust=1676809058748000&amp;usg=AOvVaw0TJUrEwe9dtCLuDJRei3xJ">docs</a>
            or find help from <a href="#" style="color:#919eab;line-height:28px;font-size:12px;text-decoration:underline" target="_blank" data-saferedirecturl="https://www.google.com/url?q=https://help.nexmo.com/&amp;source=gmail&amp;ust=1676809058748000&amp;usg=AOvVaw1GljBt6BTC7_b3-KxewTih">support</a>.
        </span>
